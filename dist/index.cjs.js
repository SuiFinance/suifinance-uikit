...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#dde5b6", backgroundDisabled: "#d5cc8b", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#CCB866", text: "#6c584c", textDisabled: "#FFFFFF", textSubtle: "#A98467", borderColor: "#E9EAEB", card: "#dde5b6", gradients: {
